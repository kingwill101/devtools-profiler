...
final Tool profileExplainHotspotsTool = Tool(
  ...
  description: 'Explain the main hotspots in a stored session profile or a direct profile artifact.',
  inputSchema: Schema.object(
    properties: {
      'path': Schema.string(
        description: 'A session directory or a direct profile artifact path. When omitted, use session selectors instead.',
      ),
      'profileId': Schema.string(
        description: 'Optional profile id to select from a session directory path. Use "overall" for the whole-session profile.',
      ),
      ...
      'sessionId': Schema.string(
        description: 'Session id to resolve under the sessions directory. Also accepts "latest".',
      ),
      'sessionPath': Schema.string(
        description: 'Direct path to a session directory.',
      ),
      'regionId': Schema.string(
        description: 'Optional explicit region id to explain. Defaults to "overall" when available.',
      ),
      ...
      'includeMethodTable': Schema.bool(
        description: 'Whether to include the DevTools-style method table in the returned profile.',
      ),
      'hideSdk': Schema.bool(
...
final Tool profileInspectMethodTool = Tool(
  ...
  description: 'Inspect one method in a stored session profile or direct profile artifact and return callers, callees, and representative paths.',
  inputSchema: Schema.object(
    properties: {
      'path': Schema.string(
        description: 'A session directory or a direct profile artifact path. When omitted, use session selectors instead.',
      ...
      'regionId': Schema.string(
        description: 'Optional explicit region id to inspect. Defaults to "overall" when available.',
      ),
      ...
      'pathLimit': Schema.int(
        description: 'Maximum representative top-down and bottom-up paths to include. Use 0 for unlimited.',
      ),
      'hideSdk': Schema.bool(
        description: 'Whether to hide Dart and Flutter SDK frames.',
      ),
...
final Tool profileSearchMethodsTool = Tool(
  ...
  description: 'Search a stored session profile or direct profile artifact for matching methods and return ranked candidates.',
  inputSchema: Schema.object(
    properties: {
      'path': Schema.string(
        description: 'A session directory or a direct profile artifact path. When omitted, use session selectors instead.',
      ...
      'regionId': Schema.string(
        description: 'Optional explicit region id to search. Defaults to "overall" when available.',
      ),
      'query': Schema.string(
        description: 'Optional method query matched against method name, id, and source location.',
      ),
...
final Tool profileCompareMethodTool = Tool(
  ...
  description: 'Compare one method across two session/profile targets and return method, caller, and callee deltas.',
  inputSchema: Schema.object(
    properties: {
      ...
      'baselineSessionId': Schema.string(
        description: 'Optional baseline session id. Also accepts "latest" or "previous".',
      ),
      ...
      'baselineProfileId': Schema.string(
        description: 'Optional profile id to select from the baseline session. Use "overall" for the whole-session profile.',
      ),
      'currentProfileId': Schema.string(
        description: 'Optional profile id to select from the current session. Use "overall" for the whole-session profile.',
      ),
      ...
      'methodLimit': Schema.int(
        description: 'Maximum method relations to include in the comparison. Use 0 for unlimited.',
      ),
    },
    additionalProperties: false,
  ),
...
final Tool profileCompareTool = Tool(
  ...
  description: 'Compare two targets with structured deltas, or supply paths for aligned cross-run CPU frames.',
  inputSchema: Schema.object(
    properties: {
      'paths': Schema.list(
        description: 'Two or more explicit session/profile paths for CPU frame alignment. Selects whole-session profiles by default; use region artifact paths for regions. Replaces pairwise selectors.',
        items: Schema.string(),
      ),
      'baselinePath': Schema.string(
        description: 'Baseline session directory or profile artifact path.',
      ...
      'methodLimit': Schema.int(
        description: 'Maximum methods to include in the method comparison. Use 0 for unlimited.',
      ),
      ...
      'treeDepth': Schema.int(
        description: 'Maximum call tree depth when trees are included. Use 0 for unlimited.',
      ),
      'treeChildren': Schema.int(
        description: 'Maximum children per call tree node when trees are included. Use 0 for unlimited.',
      ),
    },
    additionalProperties: false,
  ),
...
final Tool profileAnalyzeTrendsTool = Tool(
  ...
  description: 'Analyze a sequence of stored profiling sessions and return first-to-last deltas plus recurring regressions.',
  inputSchema: Schema.object(
    properties: {
      'paths': Schema.list(
        description: 'Explicit session directories or profile artifact paths in chronological order.',
        items: Schema.string(),
      ),
      'rootDirectory': Schema.string(
        description:
      ...
      'sessionIds': Schema.list(
        description: 'Optional explicit session ids to analyze in order. When omitted, the newest sessions are used.',
        items: Schema.string(),
      ),
      'profileId': Schema.string(
        description: 'Optional profile id to select from each session. Use "overall" for the whole-session profile.',
      ),
      'limit': Schema.int(
        description: 'Maximum newest stored sessions to analyze when paths/sessionIds are omitted. Use 0 for all.',
      ),
      'hideSdk': Schema.bool(
        description: 'Whether to hide Dart and Flutter SDK frames.',
      ),
      ...
      'methodLimit': Schema.int(
        description: 'Maximum methods to include in trend comparisons. Use 0 for unlimited.',
      ),
    },
    additionalProperties: false,
  ),
...
final Tool profileFindRegressionsTool = Tool(
  ...
  description: 'Compare stored profiling sessions, defaulting to the newest run versus the previous run, and return prioritized regression insights.',
  inputSchema: Schema.object(
    properties: {
      'rootDirectory': Schema.string(
        description:
      ...
      'baselineSessionId': Schema.string(
        description: 'Optional baseline session id. Defaults to "previous". Also accepts "latest" or "previous".',
      ),
      'currentSessionId': Schema.string(
        description: 'Optional current session id. Defaults to "latest". Also accepts "latest" or "previous".',
      ),
      'baselineProfileId': Schema.string(
        description: 'Optional baseline profile id within the session. Use "overall" for the whole-session profile.',
      ),
      'currentProfileId': Schema.string(
        description: 'Optional current profile id within the session. Use "overall" for the whole-session profile.',
      ),
      'includeCallTree': Schema.bool(
        description: 'Whether to attach top-down trees for both sides.',
      ),
  ...
  outputSchema: Schema.object(
    description: 'Structured comparison and prioritized regression summary for stored sessions.',
    additionalProperties: true,
  ),
  annotations: ToolAnnotations(
    destructiveHint: false,
...
final Tool profileInspectClassesTool = Tool(
  ...
  inputSchema: Schema.object(
    properties: {
      'path': Schema.string(
        description: 'A session directory, region summary.json, or raw memory_profile.json.',
      ),
      'classQuery': Schema.string(
        description: 'Filter to classes whose name contains this query (case-insensitive).',
      ),
      'minLiveBytes': Schema.int(
        description:
